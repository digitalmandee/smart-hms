...
import PendingCheckoutPage from "@/pages/app/opd/PendingCheckoutPage";
...
const Year1Budget = React.lazy(() => import("./pages/Year1Budget"));
...
const CashierWorkspacePage = React.lazy(() => import("./pages/app/billing/CashierWorkspacePage"));
...
import DoctorWalletBalancesPage from "./pages/app/hr/payroll/DoctorWalletBalancesPage";
...
const BloodBankAnalyticsPage = React.lazy(() => import("./pages/app/blood-bank/BloodBankAnalyticsPage"));
...
import DialysisPatientDetailPage from "./pages/app/dialysis/DialysisPatientDetailPage";
        ...
        <BrowserRouter>
          <AuthProvider>
            ...
            <Routes>
              ...
              <Route path="/year1-budget" element={<React.Suspense fallback={<div className="flex items-center justify-center min-h-screen">Loading...</div>}><Year1Budget /></React.Suspense>} />
            ...
            >
              ...
              <Route path="opd/checkout" element={<OPDCheckoutPage />} />
              <Route path="opd/checkout/:appointmentId" element={<OPDCheckoutPage />} />
              <Route path="opd/pending-checkout" element={<PendingCheckoutPage />} />
              ...
              <Route path="dialysis/patients/:id" element={<DialysisPatientDetailPage />} />
              ...
              <Route path="billing/cashier" element={<React.Suspense fallback={<div>Loading...</div>}><CashierWorkspacePage /></React.Suspense>} />
