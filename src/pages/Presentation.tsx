...
const features = [
  ...
  },
  {
    ...
    description: 'Token-based queue system with real-time TV display boards showing current and upcoming tokens. AI-assisted scheduling optimization balances doctor workloads and reduces wait times. Interactive calendar grid for scheduling follow-ups, managing walk-ins, and enabling online patient self-booking. Automated SMS/Email reminders reduce no-shows by 40%.',
  ...
  },
  {
    ...
    description: 'Handle critical cases with speed and precision. AI triage assistance provides severity scoring recommendations based on symptoms and vitals. Triage patients with 5-level severity scoring (Red/Orange/Yellow/Green/Blue) that auto-prioritizes the queue. Track trauma cases with injury body-map documentation and Glasgow Coma Scale. Receive ambulance alerts with pre-hospital data.',
  ...
  },
  {
    ...
    description: 'Empower nurses with digital tools for exceptional patient care. AI-powered vitals anomaly detection flags concerning trends before they become critical. Monitor vitals in real-time with trend analysis and auto-alerts for abnormal values. Administer medications with eMAR barcode verification ensuring 5 Rights. Document nursing notes per shift with structured templates.',
  ...
  },
  {
    ...
    description: 'Order tests during consultations with pre-built panels (CBC, LFT, RFT, Lipid Profile, Thyroid). Track samples with barcodes from collection to result. AI flags abnormal results with clinical context and suggests follow-up tests. Enter results using structured templates with auto-calculated derived values and age/gender-specific reference ranges.',
  ...
  },
  {
    ...
    description: 'Track medicine stock by batch number and expiry date with automated alerts 30/60/90 days before expiration. AI-powered drug interaction alerts check against patient allergies, current medications, and contraindications. Dispense prescriptions with barcode scanning for accuracy. Manage multiple suppliers with price comparison and order history.',
  ...
  },
  {
    ...
    description: 'Generate service-based invoices for consultations, labs, imaging, procedures, and pharmacy with itemized breakdowns. AI-suggested billing codes from diagnosis streamline charge capture. Accept multiple payment methods with partial payment support and balance tracking. Submit insurance claims electronically with panel rates and authorization tracking.',
  ...
  },
  {
    ...
    description: 'AI-driven insights and predictive analytics surface trends before you ask. Track revenue trends, patient visit patterns, and department performance with interactive dashboards. Visualize data with charts, graphs, and heat maps. Build custom reports with drag-and-drop report builder selecting fields from any module.',
