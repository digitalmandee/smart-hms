...
import { OtDocLiveSurgery } from "@/components/ot-docs/OtDocLiveSurgery";
import { OtDocPostOp } from "@/components/ot-docs/OtDocPostOp";
...
const pages = [
  ...
  { id: "live", label: "Live Surgery", component: OtDocLiveSurgery },
  { id: "postop", label: "Post-Op", component: OtDocPostOp },
];

const OtDocumentation = () => {
  ...
  const handleDownloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const blob=pdf.output("blob");const url=URL.createObjectURL(blob);const link=document.createElement("a");link.href=url;link.download="HealthOS24-Surgery-OT-Documentation.pdf";document.body.appendChild(link);link.click();
...
export default OtDocumentation;
