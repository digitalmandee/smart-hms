...
import { DialDocSchedule } from "@/components/dialysis-docs/DialDocSchedule";
...
const pages = [
  ...
  { id: "schedule", label: "Schedule", component: DialDocSchedule },
];

const DialysisDocumentation = () => {
  ...
  const handleDownloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const blob=pdf.output("blob");const url=URL.createObjectURL(blob);const link=document.createElement("a");link.href=url;link.download="HealthOS24-Dialysis-Documentation.pdf";document.body.appendChild(link);link.click();
...
export default DialysisDocumentation;
