...
const RadiologyDocumentation = () => {
  ...
  const handleDownloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const blob=pdf.output("blob");const url=URL.createObjectURL(blob);const link=document.createElement("a");link.href=url;link.download="HealthOS24-Radiology-Documentation.pdf";document.body.appendChild(link);link.click();
...
export default RadiologyDocumentation;
