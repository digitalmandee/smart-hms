...
import { WhDocKpi } from "@/components/warehouse-docs/WhDocKpi";
...
const pages = [
  ...
  { id: "kpi", label: "KPIs", component: WhDocKpi },
];

const WarehouseDocumentation = () => {
  ...
  const handleDownloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const blob=pdf.output("blob");const url=URL.createObjectURL(blob);const link=document.createElement("a");link.href=url;link.download="HealthOS24-Warehouse-Documentation.pdf";document.body.appendChild(link);link.click();
...
export default WarehouseDocumentation;
