...
export const TitleSlide = () => {
  ...
  return (
    <div className="slide flex flex-col items-center justify-center bg-gradient-to-br from-primary/10 via-background to-primary/5 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      {/* Main Title */}
      <h1 className="text-5xl md:text-6xl font-bold text-center mb-4 leading-tight relative z-10">
        Complete Hospital<br />
        <span className="text-primary">Management System</span>
      </h1>

      {/* Subtitle */}
      <p className="text-2xl text-muted-foreground text-center mb-8 max-w-2xl relative z-10">
        20 Integrated Modules for Modern Healthcare Operations
      </p>

      {/* Feature highlights */}
      <div className="flex flex-wrap justify-center gap-3 mb-8 max-w-4xl relative z-10">
        {highlights.map((item) => (
          <span
            key={item}
      ...
      {/* Stats Bar */}
      <div className="flex items-center gap-8 bg-card border border-border rounded-2xl px-8 py-4 shadow-lg relative z-10">
