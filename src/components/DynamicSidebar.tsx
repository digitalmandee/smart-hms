...
export const SIDEBAR_NAME_TO_KEY: Record<string, TranslationKey> = {
  ...
  // Sub-items: Finance / Accounts — Phase 5 menu restructure
  ...
  "Cost Center P&L": "nav.costCenterPnl",
  "Detailed P&L": "nav.detailedPnl",
  "Consolidated P&L": "nav.consolidatedPnl",
  "Budget Variance": "nav.budgetVariance",
  "AR Reconciliation": "nav.arReconciliation",
  "Cash to Bank": "nav.cashToBank",
  "Payroll Cost Allocation": "nav.payrollCostAllocation",
  "VAT Return": "nav.vatReturn",
  "Year-End Closing": "nav.yearEndClosing",
  ...
  "Year-End Closing": "nav.yearEndClosing" as any,
  "Recurring Entries": "nav.recurringEntries" as any,
  "PDC Register": "nav.pdcRegister" as any,
