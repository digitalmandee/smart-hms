...
export const DialDocSessions = () => (
  <DocPageWrapper pageNumber={5} totalPages={7} moduleTitle="Dialysis Center">
    ...
    <SubSection title="Intra-Dialysis Monitoring">
      <FeatureList items={["Vitals recorded every 30 minutes: BP, pulse, UF rate","Real-time vitals chart with trend visualization","BP alert: automatic flag if systolic drops below threshold","Heparin dose tracking with timed administration","Complications log: cramps, hypotension, nausea, clotting","Nurse notes with timestamped entries"]} />
    </SubSection>
    <SubSection title="Post-Dialysis">
      <MockupTable headers={["Step", "Detail"]} rows={[["Post-Weight","Record weight — system calculates actual UF"],["Post-Vitals","Standing and sitting BP, temperature"],["Access Care","Hemostasis time, bandaging notes"],["Session Summary","Duration, actual UF, complications, Kt/V"],["Next Session","Confirm or reschedule next appointment"]]} />
    </SubSection>
