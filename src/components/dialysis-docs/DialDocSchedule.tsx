...
export const DialDocSchedule = () => (
  <DocPageWrapper pageNumber={7} totalPages={7} moduleTitle="Dialysis Center">
    ...
    <SubSection title="Capacity Dashboard">
      <MockupTable headers={["Metric", "Description"]} rows={[["Total Chairs","Available chairs per shift"],["Utilization Rate","Sessions completed / available slots"],["No-Show Rate","Missed sessions as % of scheduled"],["Average Duration","Mean session time in minutes"],["Machine Uptime","% of machines available vs maintenance"]]} />
    </SubSection>
    <SubSection title="Reports & Analytics">
      <MockupTable headers={["Report", "Content"]} rows={[["Session Summary","Daily/weekly sessions by shift, chair, machine"],["Patient Adequacy","Kt/V trends, URR, target achievement"],["Complications","Frequency of hypotension, cramps, clotting"],["Machine Usage","Sessions per machine, disinfection compliance"],["Financial","Revenue per session, insurance claims status"]]} />
    </SubSection>
    <TipBox title="Automated Reminders">Patients receive SMS/WhatsApp reminders 24 hours before scheduled sessions.</TipBox>
  </DocPageWrapper>
);
