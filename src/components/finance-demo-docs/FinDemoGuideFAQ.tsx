import { DocPageWrapper, SectionTitle, SubSection } from "@/components/pharmacy-docs/DocPageWrapper";
...
export const FinDemoGuideFAQ = ({ totalPages }: { totalPages: number }) => (
  <DocPageWrapper pageNumber={15} totalPages={totalPages}>
    <SectionTitle icon="❓" title="Demo FAQ — 29 Questions" subtitle="Organized by Category with Route References" />
