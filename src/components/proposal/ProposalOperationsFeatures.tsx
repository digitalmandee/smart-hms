import { Activity, ShoppingBag, Users2, Boxes, Fingerprint, CalendarClock, CalendarOff, Banknote, UserCog, Wrench, Sparkles, UtensilsCrossed, BarChart2 } from "lucide-react";
