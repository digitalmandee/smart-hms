import { Activity, UserPlus, Calendar, ListOrdered, Stethoscope, Ambulance, Bed, Heart, Pill, ClipboardCheck, Scissors, Syringe, ThermometerSun, Baby, Activity as ICUIcon } from "lucide-react";
